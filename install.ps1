param (
  [Parameter()]
  [switch]
  $UninstallSpotifyStoreEdition = (Read-Host -Prompt 'Hai greetings from Krishnamenan, press Y to uninstall spotify microsoft store edition') -eq 'y',
  [Parameter()]
  [switch]
  $UpdateSpotify
)
